...
{
       0,   143,   143,   154,   167,   175,   184,   193,   202,   212,
     222,   231,   240,   250,   259,   269,   278,   288,   296,   305,
     315,   323,   333,   341,   350,   360,   368,   377,   386,   395,
     404,   413,   422,   431,   440,   449,   459,   490,   499,   508,
     517,   526,   535,   544,   554,   563,   572,   581,   590,   599,
     608,   617,   626,   636,   664,   675,   684,   693,   702,   711,
     721,   729,   739,   747,   756,   765,   774,   783,   792,   801,
     810,   821,   830,   839,   854
};
#endif
...
static const char *const yytname[] =
{
  ...
  "class_vector", "identifiers", "functions", "function",
  "function_params", "remaining_function_params", "function_param",
  "function_declarations", "statements", "statement", "simple_statement",
  "block", "assignment", "vector_element", "conditional", "loop",
  "reading", "writing", "function_return", "exp", "exp_list",
  "exp_remaining_list", "comparison", "constant", "constant_logic",
  "constant_int", "identifier", YY_NULLPTR
};
#endif
...
{
       2,    16,    10,    17,   -40,   -40,   -40,    12,   -40,    17,
     -39,   -40,   -40,   -40,    24,    34,   -40,   -40,    29,    35,
      14,    12,   -40,    34,   -40,   -39,   -40,    43,   -39,    22,
     -40,   -40,   -40,    48,    50,    51,   -39,    88,    88,    46,
      49,    22,    57,   -40,   -40,    47,   -40,   -40,   -40,   -40,
     -40,    68,    12,    88,    88,   -40,    88,    88,    88,   -40,
     -40,    -4,   -40,    55,   -40,   -40,   -40,    21,    55,    88,
     -40,   -40,   -40,    88,    88,   -39,    70,    74,   124,   134,
     110,    72,   -40,   -40,    88,    88,    88,    88,    88,    88,
      88,    55,    55,   142,   -40,    73,    12,   -40,    76,    77,
     -40,    88,    88,    88,    88,    88,    88,   -40,   -18,   -18,
     -40,   -40,   -40,   -18,    23,    82,   -40,    17,    74,    22,
      22,    55,    55,    55,    55,    55,    55,    88,   -40,   -40,
     -40,    22,   -40,    69,    79,    23,    80,    93,   -40,   -40,
     -40,    86,    22,    87,   -40
};
...
static const yytype_int8 yydefact[] =
{
      ...
      48,    47,    50,    51,    62,     0,    38,    25,    22,     0,
       0,    67,    68,    63,    64,    65,    66,     0,    59,    58,
...
{
     -40,   -40,   -40,   -40,    -6,   -40,   -40,   -40,    -1,   -40,
      90,    84,   -40,   -40,    -5,    20,   -40,   -37,   -40,   -40,
     -40,   -40,   -28,   -40,   -40,   -40,   -40,   -40,   -29,   -40,
     -17,   -40,   -40,   -40,    97,   -10
};
...
{
      19,    45,    17,    16,    71,     1,    14,    86,    87,    68,
       4,    88,   -74,    45,   -74,    19,     5,     6,    33,    51,
      28,     5,     6,     7,    78,    79,    55,    80,    82,    83,
      34,    51,    35,    36,    37,    38,     3,    90,   127,    74,
      91,    21,    20,    24,    92,    93,    84,    85,    86,    87,
      25,    75,    88,    89,    26,   108,   109,   110,   111,   112,
     113,   114,    32,    39,    52,    94,    53,    54,    69,    73,
      70,    72,   121,   122,   123,   124,   125,   126,    84,    85,
      86,    87,   133,   134,    88,    89,    74,    95,    96,   107,
     137,    45,    45,   117,   136,    75,   119,   120,   135,   129,
     138,   140,   141,    45,    56,   143,   142,    30,   144,    51,
      51,   130,    57,   132,    45,    31,   118,    27,   139,    58,
       0,    51,     0,     0,    59,    60,     0,   100,    26,    61,
       0,     0,    51,    84,    85,    86,    87,   101,   102,    88,
      89,    98,   103,   104,   105,   106,     0,    84,    85,    86,
      87,    99,     0,    88,    89,     0,     0,    84,    85,    86,
      87,   116,     0,    88,    89,    84,    85,    86,    87,     0,
       0,    88,    89
};

static const yytype_int16 yycheck[] =
{
      10,    29,    41,     9,    41,     3,     7,    25,    26,    38,
       0,    29,    16,    41,    18,    25,     4,     5,    28,    29,
      21,     4,     5,     6,    53,    54,    36,    56,    57,    58,
       8,    41,    10,    11,    12,    13,    20,    16,    15,    18,
      69,     7,    18,    14,    73,    74,    23,    24,    25,    26,
      15,    52,    29,    30,    40,    84,    85,    86,    87,    88,
      89,    90,    19,    41,    16,    75,    16,    16,    22,    22,
      21,    14,   101,   102,   103,   104,   105,   106,    23,    24,
      25,    26,   119,   120,    29,    30,    18,    17,    14,    17,
      21,   119,   120,    20,   131,    96,    20,    20,   127,    17,
      21,    21,     9,   131,    16,   142,    20,    23,    21,   119,
     120,   117,    24,   118,   142,    25,    96,    20,   135,    31,
      -1,   131,    -1,    -1,    36,    37,    -1,    17,    40,    41,
      -1,    -1,   142,    23,    24,    25,    26,    27,    28,    29,
      30,    17,    32,    33,    34,    35,    -1,    23,    24,    25,
      26,    17,    -1,    29,    30,    -1,    -1,    23,    24,    25,
      26,    19,    -1,    29,    30,    23,    24,    25,    26,    -1,
      -1,    29,    30
};
...
static const yytype_int8 yystos[] =
{
      ...
      48,    49,    50,    51,    50,    44,    46,    41,    52,    77,
      18,     7,    53,    54,    14,    15,    40,    76,    50,    45,
      53,    52,    19,    77,     8,    10,    11,    12,    13,    41,
      59,    60,    61,    62,    63,    64,    65,    66,    67,    68,
      69,    77,    16,    16,    16,    77,    16,    24,    31,    36,
      37,    41,    64,    70,    74,    75,    76,    77,    70,    22,
      21,    59,    14,    22,    18,    50,    55,    57,    70,    70,
      70,    73,    70,    70,    23,    24,    25,    26,    29,    30,
      16,    70,    70,    70,    77,    17,    14,    56,    17,    17,
      17,    27,    28,    32,    33,    34,    35,    17,    70,    70,
      70,    70,    70,    70,    70,    71,    19,    20,    57,    20,
      20,    70,    70,    70,    70,    70,    70,    15,    72,    17,
      46,    58,    56,    59,    59,    70,    59,    21,    21,    72,
      21,     9,    20,    59,    21
};
...
#line 460 "alfa/alfa.y"
    {
      ...
      if((_sleft = st_searchCurrentScope(st, (yyvsp[-2].attrs).lexeme)) == NULL)
      {
        ...
        COPYERR("Identifier %s not declared.", (yyvsp[-2].attrs).lexeme); 
        return PARSEFAIL;
      }
      if(symbol_get_category(_sleft) == FUNCT)
      {
        COPYERR("Identifier %s is a function.", (yyvsp[-2].attrs).lexeme); 
        return PARSEFAIL;
      }
      else if(symbol_blind_identifierCategory(_sleft) == VECTOR)
      {
        COPYERR("Identifier %s is a vector.", (yyvsp[-2].attrs).lexeme); 
        return PARSEFAIL;
      }
      ...
      write_assignment(FPASM_NAME, (yyvsp[-2].attrs).lexeme, (yyvsp[0].attrs).is_dir);
    }
#line 1870 "y.tab.c"
    break;

  case 37:
#line 491 "alfa/alfa.y"
    {
...
#line 1999 "y.tab.c"
  ...
  case 53:
#line 637 "alfa/alfa.y"
    {
      PRINT_RULE("<exp> ::= <identificador>", 80);
      if((_sleft = st_searchCurrentScope(st, (yyvsp[0].attrs).lexeme)) == NULL)
      {
        COPYERR("Identifier %s doesn't exists", (yyvsp[0].attrs).lexeme);
        return PARSEFAIL;
      }
      if(symbol_get_category(_sleft) == FUNCT)
      {
        COPYERR("Identifier %s is a function", (yyvsp[0].attrs).lexeme);
        return PARSEFAIL;
      }
      else if(symbol_blind_identifierCategory(_sleft) == VECTOR)
      {
        COPYERR("Identifier %s is a vector", (yyvsp[0].attrs).lexeme);
        return PARSEFAIL;
      }
      (yyval.attrs).type = symbol_blind_dataType(_sleft);
      (yyval.attrs).is_dir = true;

      write_operand(FPASM_NAME, (yyvsp[0].attrs).lexeme, (yyval.attrs).is_dir);
    }
#line 2026 "y.tab.c"
    break;
...
#line 665 "alfa/alfa.y"
    {
      ...
      (yyval.attrs).is_dir = (yyvsp[0].attrs).is_dir;
    }
#line 2036 "y.tab.c"
    break;

  case 55:
#line 676 "alfa/alfa.y"
    {
